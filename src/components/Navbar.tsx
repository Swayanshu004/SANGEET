...
function Navbar({ className }: { className?: string }) {
  ...
  return (
    <div className={cn("fixed top-2 inset-x-0 max-w-full mx-auto z-50 flex items-center justify-between px-10", className)}>
        <Link href={"/"}>
          <h1 className="text-2xl md:text-4xl font-bold text-orange-600">संगीत</h1>
        </Link>
