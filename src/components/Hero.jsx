...
function Hero() {
  return (
    <div className='h-screen md-h-[40rem] w-full rounded-md flex flex-col items-center justify-center relative overflow-hidden px-10 mx-auto py-10 md:py-0'>
        <Spotlight
        ...
        <div className='w-full p-4 z-9 relative text-center'>
            ...
            <p className="font-normal mb-4 mt-2 text-xl md:text-2xl text-orange-600 max-w-lg mx-auto">Art | Guidance | Exposer</p>
            <div className="mt-10">
                <Link href={"/courses"}>
                <Button
